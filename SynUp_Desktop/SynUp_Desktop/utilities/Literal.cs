...
namespace SynUp_Desktop.utilities
{
    public static class Literal
    {
        ...
        public static readonly string ADD_ALL_EMPLOYEE_TO_TEAM_ERROR = "Some of the selected employee couldn't be added to the team.";
        public static readonly string DELETE_ALL_EMPLOYEE_TO_TEAM_ERROR = "Some of the selected employees couldn't be deleted from the team.";
